...
theme: /
    ...
    state: Skills
        intent!: /Умения
        a: Я умею играть в игры "Города", "Угадай число", "100 спичек" и "Кости". Также есть связь с богами, они мне дают информацию о погоде в любом городе (ну почти) и могу конвертировать валюту.
...
theme: /
    ...
    state: Количество
        ...
        InputNumber:
            ...
            failureMessage = ["Не могли бы вы попробовать еще раз?", "Пожалуйста, введите число в диапазоне [1:1000000000000000]"
            minValue = 1
    ...
    state: Изчего
        InputText:
            varName = from
            prompt = Введи название валюты, в которую хочешь конвертировать, например: RUB - рубли, EUR - евро...
            then = /Вочто
        script:
